...
class NotFoundError(Exception):
	"""Error for when a specific field of data was not found in database, which is different from HTTP Not Found error"""
...
class DatabaseError(Exception):
	"""Generic error for database query failures; metadata will provide hidden message which will be logged"""
